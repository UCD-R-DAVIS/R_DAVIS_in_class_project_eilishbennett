...
#The dollar sign selects a column from the data frame 
...
surveys %>%
  mutate(hindfoot_cat = case_when(
    hindfoot_length > 29.29 ~ "big", # if the hindfootlength is over the mean (29.29), I want it to be reclassified as "big"
